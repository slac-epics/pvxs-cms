...
.. code-block:: shell
    ...
    cd ${PROJECT_HOME}
    git clone --branch 7.0-secure-pvaccess https://github.com/slac-epics/epics-base-tls.git
    cd epics-base
...
.. code-block:: shell
    ...
    git clone --recursive  --branch tls https://github.com/slac-epics/pvxs-tls.git
    cd pvxs
