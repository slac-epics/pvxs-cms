...
lb_l = fields('Role: facility load balancer, layer 4','Image: haproxy',
 ...
 'eth2  net-lab        10.89.0.0/24   a foot in each network that',
 'eth3  net-ml         10.89.1.0/24       names it, aliased "facility"',
 ...
 'Same port each side: a search reply names the server\'s own port',
 'Backends carry resolve-net 10.89.2.0/24 - a gateway has an address',
 '    on two segments and serves only the DMZ one')
